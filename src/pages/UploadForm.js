...
const UploadForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const uploadResponse = await axios.post("https://0wgtgjhv-8000.inc1.devtunnels.ms/upload", formData, {
      ...
      if (uploadResponse.data.video_id) {
        ...
        axios.post(`https://0wgtgjhv-8000.inc1.devtunnels.ms/analyze/${uploadResponse.data.video_id}`).catch((error) => {
